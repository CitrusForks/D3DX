...
//Empty D3DXVECTOR3
const D3DXVECTOR3 VecNull   = D3DXVECTOR3(0.0f);

//Empty D3DXVECTOR4
const D3DXVECTOR4 Vec4Null  = D3DXVECTOR4(0.0f);

//Constant Vector
const D3DXVECTOR3 VecHalf   = D3DXVECTOR3(0.5f);
const D3DXVECTOR3 VecOne    = D3DXVECTOR3(1.0f);
